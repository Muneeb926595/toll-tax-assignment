...
export const Container = (props: Props) => {
    const { hasScroll, bounces, onScroll, scrollEventThrottle, options, keyboardBehaviour, persistTaps, insetsToHandle, containerStyles, screenBackgroundStyle, scrollViewContentContainerStyles } = props
    ...
    return (
        ...
        >
            <KeyboardAvoidingView
                style={{ flex: 1, }}
                behavior={keyboardBehaviour ? keyboardBehaviour : isAndroid ? null : 'padding'}
